            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                  ...
                  <form @submit.prevent="submitForm">
                    ...
                    <div class="row mb-3">
                      <label for="reason" class="form-label">Reson for joining</label>
...
const validateReason = (blur) => {
  if (formData.value.reason.length < 2) {
    if (blur) errors.value.reason = "Reason must be at least 2 characters long.";
  } else {
